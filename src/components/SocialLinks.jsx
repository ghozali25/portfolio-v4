...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/ahmadghozali25",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "Ahmad Ghozali",
    icon: Instagram,
    url: "https://www.instagram.com/ahmadghozali25/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@ghozali25",
    icon: Github,
    url: "https://github.com/ghozali25",
    color: "#ffffff",
  ...
  },
  {
    ...
    subText: "Ghozali",
    icon: Mails,
    url: "mailto:ghozali.ahmd25@gmail.com",
    color: "#FF0000",
...
const SocialLinks = () => {
  ...
  const [instagram, Mails, github, tiktok] = otherLinks;
...
>
  ...
  >
    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent
        ...
        {/* Second Row - Instagram & Mails */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[instagram, Mails].map((link) => (
            <a
              key={link.name}
              href={link.url}
              target="_blank"
