...
const StatusBadge = memo(() => (
  <div className="hidden sm:inline-block animate-float lg:mx-0" data-aos="zoom-in" data-aos-delay="400">
    ...
    <button className="group relative w-[160px]">
      ...
      <div className="relative h-11 bg-[#030014] backdrop-blur-xl rounded-lg border border-white/10 leading-none overflow-hidden">
        ...
        <span className="absolute inset-0 flex items-center justify-center gap-2 text-sm group-hover:gap-3 transition-all duration-300">
          ...
          <Icon className={`w-4 h-4 sm:w-5 sm:h-5 md:w-5 md:h-5 text-gray-200 ${text === 'Contact' ? 'group-hover:translate-x-1' : 'group-hover:rotate-45'} transform transition-all duration-300 z-10`} />
        </span>
      </div>
    </button>
  </a>
...
const WORDS = ["Data Analyst", "Data Science", "Accounting"];
const TECH_STACK = ["Excel", "PowerBI", "Looker", "Tableau", "SQL"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/ghozali25" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/ahmadghozali25/" }
];
      ...
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[10%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            <div className="w-full max-w-[520px] mx-auto py-[10%] sm:py-0 lg:w-1/2 h-auto lg:h-[600px] xl:h-[750px] relative flex items-center justify-center order-2 lg:order-2 mt-8 lg:mt-0 overflow-hidden"
